...
abstract class AppTheme {
  ...
  static ThemeData light() => ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(secondary: accentColor, brightness: Brightness.light),
  ...
  static ThemeData dark() => ThemeData(
      ...
      textTheme: GoogleFonts.mulishTextTheme().apply(bodyColor: AppColors.textLight),
